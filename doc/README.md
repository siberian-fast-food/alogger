...
Configuration
-------------
alogger can be configured to write different flows (or streams of log messages) to different loggers. It can be done in config (alog.config) or in runtime with [`alog_control`](alog_control.md) module.
<pre>
        [{alog, [
...
<tr><td><a href="alog_disk_log.md" class="module">alog_disk_log</a></td></tr>
